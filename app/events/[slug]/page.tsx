...
export async function generateMetadata(
    ...
    try {
        ...
        ogImageURL = `${process.env['HOST']}/api/imageHandler?slug=${slug}`;
    ...
    */
    ...
    const fcMetadata: Record<string, string> = {
        "fc:frame": "vNext",
        "fc:frame:post_url": `${process.env['HOST']}/api/s/event?slug=${slug}&register=true&firstvisit=true`,
        "fc:frame:image": `${ogImageURL}`,
        "fc:frame:image:aspect_ratio": `1.91:1`,
        "fc:frame:button:1:action": `link`,
        "fc:frame:button:1:target": `${regLink}`,
    };
    ["Register", "Show location", "See description", ""].filter(o => o !== "").map((option, index) => {
